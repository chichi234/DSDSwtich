...
//    private TextView mImageViewClose;//关闭
...
//    private TextView    mTvHint;//提示 (提示:密码错误,重新输入)
    ...
    private void initView() {
        mPassLayout = LayoutInflater.from(mContext).inflate( R.layout.dialog_password_confirm1, null);
    ...
    BaseAdapter adapter = new BaseAdapter() {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (position == 9) {
                ...
                holder.btnNumber.setBackgroundColor(0xe5e5e5);
            }
            if (position == 11) {
                holder.btnNumber.setText("");
